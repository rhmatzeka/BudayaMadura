...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'E-Ensiklopedia Etnosains Madura'); ?></title>
...
<body>
    ...
    <nav class="main-nav">
        <div class="container">
            <ul class="nav-menu">
                ...
                <li><a href="<?php echo e(route('modul.index')); ?>" class="<?php echo e(request()->routeIs('modul.*') ? 'active' : ''); ?>">
    ...
    <section class="glosarium-widget">
        <div class="container">
            ...
            <div class="glosarium-grid">
                ...
                <?php $__currentLoopData = $glosariumItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="glosarium-item">
                    <h5><?php echo e($item->istilah); ?></h5>
                    <p><?php echo e(Str::limit($item->arti_istilah, 80)); ?></p>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('glossarium.index')); ?>" class="btn btn-primary-custom">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('home')); ?>"><i class="fas fa-angle-right me-2"></i>Beranda</a></li>
                        <li><a href="<?php echo e(route('modul.index')); ?>"><i class="fas fa-angle-right me-2"></i>Daftar Isi</a></li>
                        <li><a href="<?php echo e(route('produk.index')); ?>"><i class="fas fa-angle-right me-2"></i>Produk</a></li>
                        <li><a href="<?php echo e(route('glossarium.index')); ?>"><i class="fas fa-angle-right me-2"></i>Glosarium</a></li>
                    </ul>
                </div>
                <div class="col-md-4 mb-4">
    ...
    <script>
        function performSearch() {
            ...
            if (query.trim()) {
                window.location.href = '<?php echo e(route("produk.search")); ?>?q=' + encodeURIComponent(query);
            }
        }
...
</html><?php /**PATH C:\laragon\www\e-ensiklopedia\resources\views/layouts/app.blade.php ENDPATH**/ ?>