...
<?php $__env->startSection('title', 'Beranda - E-Ensiklopedia Etnosains Madura'); ?>
...
<div class="text-center mb-5">
    <div class="row align-items-center">
        <div class="col-md-6">
            ...
            <div class="mt-4">
                <a href="<?php echo e(route('produk.index')); ?>" class="btn-vintage me-2">
                    <i class="fas fa-play-circle me-2"></i>Mulai Eksplorasi
                </a>
                <a href="<?php echo e(route('glossarium.index')); ?>" class="btn-vintage-outline">
    ...
    <div class="row">
        <div class="col-md-3 mb-3">
            <div class="icon-box-vintage">
                ...
                <h3 style="color: var(--primary-brown);"><?php echo e($jumlahProduk); ?></h3>
        ...
        <div class="col-md-3 mb-3">
            <div class="icon-box-vintage">
                ...
                <h3 style="color: var(--primary-brown);"><?php echo e($jumlahGlosarium); ?></h3>
...
<section class="mb-5">
    ...
    <div class="row">
        <?php $__currentLoopData = $produkTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="product-card-vintage">
                ...
                <?php else: ?>
                    <div style="height: 250px; background: linear-gradient(135deg, #FFF8DC 0%, #F5DEB3 100%); display: flex; align-items: center; justify-content: center; border-bottom: 3px solid var(--secondary-brown);">
                        <div class="text-center">
                            <i class="fas fa-image" style="font-size: 4rem; color: var(--secondary-brown);"></i>
                            <p style="color: var(--primary-brown); margin-top: 10px;">Gambar <?php echo e($item->nama_produk); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="card-body">
                    <h5 style="color: var(--primary-brown); font-weight: 700;"><?php echo e($item->nama_produk); ?></h5>
                    <p style="text-align: justify;"><?php echo e(Str::limit($item->deskripsi, 120)); ?></p>
                    <div class="mb-3">
                        <span class="badge-vintage"><?php echo e($item->kategori); ?></span>
                    </div>
                    <a href="<?php echo e(route('produk.show', $item->slug)); ?>" class="btn-vintage w-100 text-center">
...
<section class="mb-5">
    ...
    <div class="row">
        <?php $__currentLoopData = $produkMakanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-6 mb-4">
            <div class="card-vintage">
                <div class="row g-0">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 style="color: var(--primary-brown); font-weight: 700;"><?php echo e($item->nama_produk); ?></h5>
                            <p class="small"><?php echo e(Str::limit($item->deskripsi, 100)); ?></p>
                            <a href="<?php echo e(route('produk.show', $item->slug)); ?>" class="btn-vintage-outline btn-sm">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="icon-box-vintage">
                    ...
                    <h5 style="color: var(--primary-brown);"><?php echo e($jumlahGlosarium); ?> Istilah</h5>
                    <p class="small mb-3">Siap untuk dipelajari</p>
                    <a href="<?php echo e(route('glossarium.index')); ?>" class="btn-vintage">
...
<div class="text-center mt-5">
    <div class="d-flex justify-content-between align-items-center">
        <a href="<?php echo e(route('home')); ?>" class="btn-vintage-outline">
        ...
        <a href="<?php echo e(route('produk.index')); ?>" class="btn-vintage">
            Lanjut<i class="fas fa-arrow-right ms-2"></i>
        </a>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-ensiklopedia\resources\views/home/index.blade.php ENDPATH**/ ?>