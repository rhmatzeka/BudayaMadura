...
<?php $__env->startSection('title', 'Tentang E-Ensiklopedia - E-Ensiklopedia Etnosains Madura'); ?>
...
<div class="row g-4">
    <div class="col-md-6">
        <a href="<?php echo e(route('tentang.tujuan')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-6">
        <a href="<?php echo e(route('tentang.target-pengguna')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('tentang.keunggulan')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('tentang.petunjuk-penggunaan')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('tentang.pengenalan-etnosains')); ?>" class="text-decoration-none">
...
<div class="d-flex justify-content-center mt-5">
    <a href="<?php echo e(route('home')); ?>" class="btn btn-primary-custom me-3">
        <i class="fas fa-home me-2"></i>Kembali ke Beranda
    </a>
    <a href="<?php echo e(route('tentang.tujuan')); ?>" class="btn btn-primary-custom">
        Mulai Membaca<i class="fas fa-arrow-right ms-2"></i>
    </a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-ensiklopedia\resources\views/tentang/index.blade.php ENDPATH**/ ?>