...
<?php $__env->startSection('title', 'Tujuan E-Ensiklopedia - E-Ensiklopedia Etnosains Madura'); ?>
...
<div class="d-flex justify-content-between align-items-center mt-5">
    <a href="<?php echo e(route('tentang.index')); ?>" class="btn btn-primary-custom">
        <i class="fas fa-arrow-left me-2"></i>Kembali ke Tentang
    </a>

    <a href="<?php echo e(route('tentang.target-pengguna')); ?>" class="btn btn-primary-custom">
        Selanjutnya: Target Pengguna<i class="fas fa-arrow-right ms-2"></i>
    </a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-ensiklopedia\resources\views/tentang/tujuan.blade.php ENDPATH**/ ?>